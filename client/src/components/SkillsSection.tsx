...
export default function SkillsSection() {
  return (
    <section id="skills" className="py-24 px-6 bg-accent/20" data-testid="section-skills">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {skillCategories.map((category, index) => {
            ...
            return (
              <Card
                key={index}
                className="p-8 bg-card/50 backdrop-blur-sm border-card-border hover-elevate group"
